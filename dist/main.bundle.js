...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__login_login_component__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__user_service__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dashboard_dashboard_component__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__question_service__ = __webpack_require__(149);
...
var routes = [
    { path: "", pathMatch: 'full', component: __WEBPACK_IMPORTED_MODULE_6__login_login_component__["a" /* LoginComponent */] },
    { path: "dashboard/:id", component: __WEBPACK_IMPORTED_MODULE_8__dashboard_dashboard_component__["a" /* DashboardComponent */] }
];
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_7__user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_9__question_service__["a" /* QuestionService */]],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_service__ = __webpack_require__(60);
...
var DashboardComponent = (function () {
    function DashboardComponent(_user, _route) {
        var _this = this;
        this._user = _user;
        this._route = _route;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (!this.user) {
            this._user.find(this.currentId).then(function (data) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__User__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_service__ = __webpack_require__(60);
...
var QuestionService = (function () {
    ...
    QuestionService.prototype.find = function () {
...
var UserService = (function () {
    ...
    UserService.prototype.loginUser = function (user) {
        ...
        var bubbles = this._http.post("/login", user).map(function (data) { return data.json(); }).toPromise();
        // /*var bubbles = this._http.post("/register", user).map(data=> data.json()).toPromise();
        bubbles.then(function (data) {
    ...
    UserService.prototype.find = function (userId) {
        console.log(userId);
        return this._http.get("/users/" + userId).map(function (data) { return data.json(); }).toPromise();
    };
    return UserService;
}());
